package com.example.microservicegateway.request;
...
@FeignClient(value = "course-service", path = "/api/course", url = "${course.service.url}", configuration = FeignConfiguration.class)
